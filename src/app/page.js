...
export default function HomePage() {
  ...
  const [showInfoPopup, setShowInfoPopup] = useState(false); // New popup for membership info
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Services Section (Reduced Height) */}
      <section id="services" className="py-10 bg-red-900 text-center">
        <div className="bg-[#800020] min-h-[50vh] p-6 text-white">
      ...
      {/* About Section */}
      <section id="about" className="py-10 bg-[#800020] text-center text-white">
        <h2 className="text-3xl font-bold mb-4 text-red-700">About Us</h2>
        <p className="text-red-300 max-w-4xl mx-auto text-2xl">
          At Angelic BeautyShop, we offer high-quality salon and spa services, including hair plaiting and barbering.
          Our professional team ensures a luxurious experience every time.
        </p>
      </section>

      {/* Contact Section */}
      <section id="contact" className="py-10 bg-red-900 text-center text-white">
        <h2 className="text-3xl font-bold mb-4 text-red-700">Contact Us</h2>
        <p className="text-gray-300 text-2xl">📞 +2547 7940 588 588</p>
        <p className="text-gray-300 text-2xl">✉ info@angelicbeautyshop.com</p>
        <p className="text-gray-300 text-2xl">📍 Eastern Bypass</p>
      </section>

      {/* Floating Info Button */}
      <button
        className="fixed bottom-6 right-6 bg-red-700 text-white px-4 py-2 rounded-full shadow-lg hover:bg-red-900 transition"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center max-w-md">
            <p className="text-lg font-semibold text-red-900">
              Want to be a member? 📢 Contact us at 
              <br />
              <span className="text-red-600 font-bold">+2547 7940 588 588</span> or{" "}
              <span className="text-red-600 font-bold">info@angelicbeautyshop.com</span>
              <br />
              to register and enjoy exclusive benefits! 🎉
            </p>
            <button
